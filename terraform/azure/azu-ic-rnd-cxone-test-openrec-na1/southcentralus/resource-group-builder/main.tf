...
resource "azurerm_role_assignment" "Default_SecretsOfficer_Recording" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Key Vault Secrets Officer"
  principal_id         = "00711129-4fbc-4081-b9e7-04feaa58863d"
}
...
#Developers Recording
resource "azurerm_role_assignment" "Default_CertificateSecrets_Recording" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Key Vault Certificates Officer"
  principal_id         = "00711129-4fbc-4081-b9e7-04feaa58863d"
}
...
resource "azurerm_role_definition" "Roleassigmnet_jenkins_wem" {
  name        = "Roleassigmnet_jenkins_wem_test"
  scope       = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
...
resource "azurerm_role_assignment" "Custom_Roleassigmnet_jenkinswem" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Roleassigmnet_jenkins_wem_test"
  principal_id         = "da2bb6c6-4bc7-4592-804f-30d28618e083"
}