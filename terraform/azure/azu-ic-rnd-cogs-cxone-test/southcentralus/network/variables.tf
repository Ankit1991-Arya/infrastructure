...
variable "dmz_vnet_address_space" {
  description = "The address space to be used for the Azure virtual network."
  default     = ["10.231.8.0/21"]
  type        = list(string)
}
variable "dmz_subnet" {
  description = "Cidr for DMZ Subnet"
  default     = ["10.231.8.0/23"]
  type        = list(string)
}
...
variable "dns_servers" {
  ...
  type        = list(string)
  default     = ["172.20.34.100", "172.20.35.100"]
}
variable "tags" {
