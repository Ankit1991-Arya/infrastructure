...
resource "azurerm_role_assignment" "Default_Contributor" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Contributor"
  principal_id         = "f0c6bd0f-e9c8-464c-9ee9-c891539bd13a"
}
...
#Developers_AAI
resource "azurerm_role_assignment" "Default_Contributor_AAI" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Contributor"
  principal_id         = "da8ea6ad-7f32-40ba-aa9b-200d99023e8d"
}
