...
#Dept_ServicesAI
resource "azurerm_role_assignment" "Default_Contributor_ServicesAI" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
  role_definition_name = "Contributor"
  principal_id         = "3c223b77-babb-4862-b6d4-4c752b22589d"
}

#Dept_ServicesAI
resource "azurerm_role_assignment" "Default_VMAdmin_ServicesAI" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}"
