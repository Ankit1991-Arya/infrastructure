...
module "resource-group-builder" {
  ...
  resource_groups_system_map = {
    "arcsqlmonitor" = {
      tags = {
        ApplicationOwner    = "DBAs / dbaadmins@nice.com"
        InfrastructureOwner = "Systems Teams / systems@nice.com"
...
resource "azurerm_role_definition" "Virtual_Machine_Start_Stop_Prod" {
  name        = "Virtual_Machine_Start_Stop_Prod"
  scope       = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
...
resource "azurerm_role_assignment" "Reader_role_Prod" {
  scope                = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
...
resource "azurerm_role_assignment" "VM_Start_Stop_Prod" {
  scope                = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
  role_definition_name = "Virtual_Machine_Start_Stop_Prod"
  principal_id         = "486c88ce-773c-40b0-bd83-211333c8c4b6"
}

resource "azurerm_role_assignment" "VM_Start_Stop_Prod_SysEngg" {
  scope                = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
  role_definition_name = "Virtual_Machine_Start_Stop_Prod"
  principal_id         = "c5fbae91-ef32-4918-a74c-03e4fcbaf133"
}
resource "azurerm_role_assignment" "Release_Engineering_Prod1" {
  scope                = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
  role_definition_name = "Virtual_Machine_Start_Stop_Prod"
  principal_id         = "4782b9b4-d9dd-4b88-a7f4-1a28e1037d80"
}
resource "azurerm_role_definition" "Release_Engineering_Prod" {
  name        = "Release_Engineering_Prod"
  scope       = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246"
...
resource "azurerm_role_assignment" "Default_ResourceContributor_DBAs" {
  scope                = "/subscriptions/bfd801d5-9e25-47c9-93e4-d329d8d61246/resourceGroups/arcsqlmonitor-prod"
  role_definition_name = "Contributor"
  principal_id         = "778790df-bbb2-4388-afef-7197b4c5e0ac"
}
