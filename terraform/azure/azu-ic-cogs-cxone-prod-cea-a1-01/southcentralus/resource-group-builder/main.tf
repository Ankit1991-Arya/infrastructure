...
resource "azurerm_role_assignment" "Default_ContributorAdministrator_DevOps" {
  scope                = "/subscriptions/${data.azurerm_subscription.this.subscription_id}/resourceGroups/prod-ncus-openai/providers/Microsoft.KeyVault/vaults/prod-ncus-cea-openai"
