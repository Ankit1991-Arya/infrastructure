locals {
  ...
  temporary_admin_ips = ["49.36.51.33/32"]

  temporary_access_ips = ["49.36.51.33/32"]
}
...
module "omilia" {
  ...
  private_subnet_ids         = ["subnet-046dc55829b0a3d7b", "subnet-066786075dca8615d", "subnet-08840c583d4b64e51"]
  database_subnet_ids        = ["subnet-0ac2de39a71d5279b", "subnet-0c4f599f5d72967bb", "subnet-04f3ff44d52f04159"]
  private_nat_eip_public_ips = ["13.238.77.108/32", "54.253.168.82/32", "13.239.213.52/32"]
  ...
  map_roles = [
    {
      ...
      "rolearn" : "arn:aws:iam::438465139399:role/GroupAccess-DevOpsAdmin",
      "username" : "GroupAccess-DevOpsAdmin"
    },
    {
      "groups" : ["system:masters"],
      "rolearn" : "arn:aws:iam::438465139399:role/GroupAccess-SystemEngineering",
...
#
  ...
  // single cluster
  docdb_single_cluster_create         = false
  ...
  deployment_principal_arn = "arn:aws:iam::438465139399:role/ServiceAccess-infrastructure-live-terraform"
