...
module "vpc" {
  source = "github.com/inContact/omilia-aws-eks-network.git//modules/vpc?ref=subnet-expansion"
  ...
  kubernetes_subnets                = ["10.200.3.0/24", "10.200.4.0/24", "10.200.5.0/24"]
  ...
  tags = merge(local.standard_tags, {
    ...
    "kubernetes.io/cluster/ocp-prod-iIXZnans" = "shared"
  })
