locals {
  ...
  private_snowflake_url                              = "fo13531.ap-southeast-2.privatelink.snowflakecomputing.com"
  private_regionless_snowflake_url                   = "cxone-omilia_au2_ausov1.privatelink.snowflakecomputing.com"
  private_regionless_snowflake_url_with_hyphens      = replace(local.private_regionless_snowflake_url, "_", "-")
  private_snowflake_ocsp_url                         = "ocsp.cxone-omilia_au2_ausov1.privatelink.snowflakecomputing.com"
  ...
  private_snowsight_url                              = "app.ap-southeast-2.privatelink.snowflakecomputing.com"
  private_regionless_snowsight_url                   = "app-cxone-omilia_au2_ausov1.privatelink.snowflakecomputing.com"
