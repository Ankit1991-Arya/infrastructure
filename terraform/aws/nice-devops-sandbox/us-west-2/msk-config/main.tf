...
provider "kafka" {
  bootstrap_servers = local.bootstrap_servers #var.bootstrap-servers
  tls_enabled       = true
...
locals {
  bootstrap_servers = [
    "b-1-public.sharedmsk01uswest2.gj0gvp.c7.kafka.us-west-2.amazonaws.com:9198",
    "b-2-public.sharedmsk01uswest2.gj0gvp.c7.kafka.us-west-2.amazonaws.com:9198",
    "b-3-public.sharedmsk01uswest2.gj0gvp.c7.kafka.us-west-2.amazonaws.com:9198"
  ]
...
module "msk-config" {
  source = "github.com/inContact/terraform-modules-msk.git//modules/msk-config?ref=CNC-5046"
