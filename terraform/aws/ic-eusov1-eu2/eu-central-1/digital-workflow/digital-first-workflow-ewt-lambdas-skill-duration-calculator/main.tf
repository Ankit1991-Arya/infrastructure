...
module "digital-first-workflow-ewt-lambdas-skill-duration-calculator" {
  ...
  aws_region_id                       = "euft"
  skill_duration_calculator_image_tag = "c0713a9b3b9d85d8b75ca13a72ca9a212a707a66"
  api_gateway_authorizer_image_tag    = "c0713a9b3b9d85d8b75ca13a72ca9a212a707a66"
  ...
  key_uri                             = "https://nicecxone-sov1.eu/auth/jwks"
}