...
module "state-streams-em-contact" {
  ...
  schema-registry-url                      = "https://schema-registry-ss-vpce-eu2.omnichannel.eusov1.internal/schema-registry"
  schema-registry-mock                     = false
  schema-registry-auto-register-schemas    = false

  snapshots-enabled                       = false
  region                                  = "eu-central-1"
  environment-prefix                      = "euft"
  security-groups                         = ["sg-07a50c299a1952bf3"]
  subnets                                 = ["subnet-0824883767aafd42f", "subnet-0a31c1461f7e2380e", "subnet-048836d13062a8ed7"]
  build-artifacts-s3-bucket               = "euft-entitymanagement"
  alarm-sns-topic-name                    = "entitymanagement_alerts_account_eusov1"
  parallelism                             = 4
  parallelism-per-kpu                     = 1
  schema-registry-ssl-cert-s3-bucket-name = "ic-certs-euft"
...
module "state-streams-dfo-contact" {
  ...
  kinesis-stream-names       = "euft-de-case-events-stream" // All the stream names that the flink app will subscribe to
  msk-cluster-name           = "shared-msk01-eu-central-1"
  deploy-test-kinesis-stream = true
  kafka-output-topic         = "SuiteData.ContactEvent.V2"
  kafka-test-output-topic    = "SuiteData.IntegrationTests.ContactEvent.V1"
  ...
  schema-registry-ssl-ca-cert                         = "star_omnichannel_eusov1_internal/EUSOV1-EUFTA-INCER01-CA.cer"
  schema-registry-ssl-server-cert                     = "star_omnichannel_eusov1_internal/star.omnichannel.eusov1.internal.cer"
  orchestration-host                                  = "entitymanagement-ss-vpce-eu2.omnichannel.eusov1.internal"
...
module "state-streams-infra" {
  ...
  region             = "eu-central-1"
  environment-prefix = "euft"
  subnets            = ["subnet-0824883767aafd42f", "subnet-0a31c1461f7e2380e", "subnet-048836d13062a8ed7"] // Use Broker service subnets
  security-groups    = ["sg-07a50c299a1952bf3"]
}
...
module "state-streams-dfo-agent-contact" {
  ...
  input-source               = "kinesis"
  kinesis-stream-names       = "prod-agent-session,euft-de-platform-events-stream,euft-de-case-events-stream"
  deploy-test-kinesis-stream = true
  kafka-output-topic         = "SuiteData.AgentContactEvent.V2"
  kafka-test-output-topic    = "SuiteData.IntegrationTests.AgentContactEvent.V1"
