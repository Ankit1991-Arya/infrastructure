...
module "state-streams-em-contact" {
  ...
  schema-registry-url                      = "https://schema-registry-ss-vpce-uk2.omnichannel.uksov1.internal/schema-registry"
  schema-registry-mock                     = false
  schema-registry-auto-register-schemas    = false

  snapshots-enabled                       = false
  region                                  = "eu-west-2"
  environment-prefix                      = "uklo"
  security-groups                         = ["sg-02c9a378888d87cb8"]
  subnets                                 = ["subnet-0fa8433a762c7b766", "subnet-0da0e957ede951590", "subnet-0c6e064770bf0e4ef"]
  build-artifacts-s3-bucket               = "uklo-entitymanagement"
  alarm-sns-topic-name                    = "entitymanagement_alerts_account_uksov1"
  parallelism                             = 4
  parallelism-per-kpu                     = 1
  schema-registry-ssl-cert-s3-bucket-name = "ic-certs-uklo"
  schema-registry-ssl-ca-cert             = "star_omnichannel_uksov1_internal/UKSOV1-UKLOA-INCER01-CA.cer"
  schema-registry-ssl-server-cert         = "star_omnichannel_uksov1_internal/star.omnichannel.uksov1.internal.cer"
...
module "state-streams-dfo-contact" {
  ...
  kinesis-stream-names       = "uklo-de-case-events-stream" // All the stream names that the flink app will subscribe to
  msk-cluster-name           = "shared-msk01-eu-west-2"
  deploy-test-kinesis-stream = true
  kafka-output-topic         = "SuiteData.ContactEvent.V2"
  kafka-test-output-topic    = "SuiteData.IntegrationTests.ContactEvent.V1"
  ...
  schema-registry-ssl-ca-cert                         = "star_omnichannel_uksov1_internal/UKSOV1-UKLOA-INCER01-CA.cer"
  schema-registry-ssl-server-cert                     = "star_omnichannel_uksov1_internal/star.omnichannel.uksov1.internal.cer"
  orchestration-host                                  = "entitymanagement-ss-vpce-uk2.omnichannel.uksov1.internal"
...
module "state-streams-infra" {
  ...
  region             = "eu-west-2"
  environment-prefix = "uklo"
  subnets            = ["subnet-0fa8433a762c7b766", "subnet-0da0e957ede951590", "subnet-0c6e064770bf0e4ef"] // Use Broker service subnets
  security-groups    = ["sg-02c9a378888d87cb8"]
}
...
module "state-streams-agent-contact" {
  ...
  app-version      = "v0.23.0" // Name of the branch or tag to deploy
...
module "state-streams-multi-event-agent" {
  ...
  version           = "0.0.16" // Version of the Terraform module to deploy
  application-owner = "ESC / esc@niceincontact.com"

  app-version      = "v0.4.2" // Name of the branch or tag to deploy
  app-version-type = "tag"    // Either "branch" or "tag"
...
module "state-streams-em-contactV2" {
  source            = "spacelift.io/incontact/orch-entity-state-streams-terraform-state-streams/default"
  version           = "0.11.29" // verify and update the version of the module to deploy
  application-owner = "ESC / esc@niceincontact.com"

  app-version      = "v0.23.0" // verify and update the version of the module to deploy
  app-version-type = "tag"
...
module "state-streams-dfo-agent-contact" {
  ...
  input-source               = "kinesis"
  kinesis-stream-names       = "prod-agent-session,uklo-de-platform-events-stream,uklo-de-case-events-stream"
  deploy-test-kinesis-stream = true
  kafka-output-topic         = "SuiteData.AgentContactEvent.V2"
  kafka-test-output-topic    = "SuiteData.IntegrationTests.AgentContactEvent.V1"
  ...
  schema-registry-url                      = "https://schema-registry-ss-vpce-uk2.omnichannel.prod.internal/schema-registry"
  schema-registry-ssl-verification-enabled = false
  schema-registry-mock                     = false
  schema-registry-auto-register-schemas    = false
  msk-cluster-name                         = "shared-msk01-eu-west-2"
