...
module "digital-first-workflow-ewt-lambdas-contact-state-keeper" {
  ...
  aws_region_id                  = "acae"
  kinesis_region_id              = "ae"
  redis_url                      = "ewt-redis-cache-0001-001.ewt-redis-cache.mctogy.mec1.cache.amazonaws.com:6379 ewt-redis-cache-0001-002.ewt-redis-cache.mctogy.mec1.cache.amazonaws.com:6379"
