...
variable "ls_cloudtrail_name" {
  type    = string
  default = "inview-eusov1-eu3-cloudtrail-logs"
}

variable "ls_guardduty_name" {
  type    = string
  default = "inview-eusov1-eu3-guardduty-logs"
}

variable "sqs_subs_cloudtraillogs_name" {
  type    = string
  default = "inview-eusov1-eu3-cloudtraillogs"
}

variable "sqs_subs_guarddutylogs_name" {
  type    = string
  default = "inview-eusov1-eu3-guarddutylogs"
}
