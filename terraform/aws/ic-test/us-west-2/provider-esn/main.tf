...
# Uncomment below code if we want mrm elasticache to be created in ic-test account
...
#     email5 = "mugdha.kulkarni@nice.com"
#     email6 = "nayan.modhave@nice.com"
#     email7 = "neha.jagtap@nice.com"
#   }
...
# No need to do anything in below code as it will create the alarms for mrm elasticache cluster when it is created in ic-test account when mrm elasticache is created
