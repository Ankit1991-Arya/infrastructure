...
resource "aws_ecr_pull_through_cache_rule" "docker_hub" {
  ...
  credential_arn        = "arn:aws:secretsmanager:us-west-2:265671366761:secret:ecr-pullthroughcache/dockerhub-blsqZ0"
}

resource "aws_ecr_pull_through_cache_rule" "github" {
  ecr_repository_prefix = "ghcr.io"
  upstream_registry_url = "ghcr.io"
  credential_arn        = "arn:aws:secretsmanager:us-west-2:265671366761:secret:ecr-pullthroughcache/ghcr-5Su5mt"
}