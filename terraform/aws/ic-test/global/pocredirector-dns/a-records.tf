...
module "pocredirector_na1" {
  ...
  # area_id = "na1" # Default
  # port = "5060" # Default
  nlb_addresses = ["10.9.65.254", "10.9.67.254", "10.9.69.254"]
  domain        = local.domain
}
...
module "pocredirector_next_na1" {
  ...
  # area_id = "na1" # Default
  # port = "5060" # Default
  nlb_addresses = ["10.9.65.251", "10.9.67.251", "10.9.69.251"]
  domain        = local.domain
}

module "pocredirector_mock_na1" {
  source  = "spacelift.io/incontact/pocredirector-dns-a/default"
  version = "0.0.3"
  ...
  # area_id = "na1" # Default
  # port = "5060" # Default
  nlb_addresses = ["10.9.65.252", "10.9.67.252", "10.9.69.252"]
  domain        = local.domain
}
