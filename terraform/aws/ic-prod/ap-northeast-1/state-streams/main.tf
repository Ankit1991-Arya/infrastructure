...
module "state-streams-em-contact" {
  ...
  msk-cluster-name           = "shared-msk01-ap-northeast-1"

  schema-registry-url                      = "https://schema-registry-ss-vpce-jp1.omnichannel.prod.internal/schema-registry"
  ...
  security-groups           = ["sg-00b6569e5f49138e7"]
  subnets                   = ["subnet-08adf1626452d996f", "subnet-08d83dd8afb533374", "subnet-02d6bcf52dac68491"]
  build-artifacts-s3-bucket = "aj-entitymanagement"
  alarm-sns-topic-name      = "entitymanagement_alerts_account_prod"
  parallelism               = 4
  parallelism-per-kpu       = 1

  schema-registry-ssl-cert-s3-bucket-name = "ic-certs-aj"
...
module "state-streams-dfo-contact" {
  ...
  kinesis-stream-names       = "aj-de-case-events-stream" // All the stream names that the flink app will subscribe to
  deploy-test-kinesis-stream = true
  kafka-output-topic         = "SuiteData.ContactEvent.V2"
  kafka-test-output-topic    = "SuiteData.IntegrationTests.ContactEvent.V1"
  msk-cluster-name           = "shared-msk01-ap-northeast-1"
...
module "state-streams-dfo-agent-contact" {
  ...
  input-source               = "kinesis"
  kinesis-stream-names       = "prod-agent-session,aj-de-platform-events-stream,aj-de-case-events-stream"
  deploy-test-kinesis-stream = true
  ...
  schema-registry-ssl-ca-cert                         = "star_omnichannel_prod_internal/lax-incer01.cer"
  schema-registry-ssl-server-cert                     = "star_omnichannel_prod_internal/star.omnichannel.prod.internal.cer"
  orchestration-host                                  = "entitymanagement-ss-vpce-jp1.omnichannel.prod.internal"
  orchestration-port                                  = 443
  orchestration-request-timeout-ms                    = 500
  orchestration-requests-enabled                      = false
  flink-runtime                                       = "FLINK-1_20"
