...
data "aws_sns_topic" "cloudwatch_bmc_critical" {
  # Note: This change should be verified with the sns name of bmc 
  #       topic present in respective accounts & should not be 
  #       applied if the name of the topics do not have 
  #       env preifx & are "cloudwatch-bmc-severity".
  name = "cloudwatch-bmc-critical"
}
