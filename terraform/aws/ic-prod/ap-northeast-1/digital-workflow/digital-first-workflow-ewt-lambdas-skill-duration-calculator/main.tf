...
module "digital-first-workflow-ewt-lambdas-skill-duration-calculator" {
  ...
  redis_url                           = "ewt-redis-cache-0001-001.ewt-redis-cache.t203ux.apne1.cache.amazonaws.com:6379 ewt-redis-cache-0001-002.ewt-redis-cache.t203ux.apne1.cache.amazonaws.com:6379"
