...
module "msk" {
  ...
  vpc-id                                    = "vpc-0397f648b426ce77e"
  internet-gateway-id                       = "igw-01bad5543d66ed194"
  subnet-cidrs                              = local.subnet-cidrs
  availability-zones                        = local.availability-zones
  allowed-cidrs                             = local.cidr_ranges.allowed_cidrs
  security_group_ids                        = ["sg-08f78af0cf46b8ba3", "sg-0cd9b053ffd9220ab", "sg-0016f9dc6d3db1e00", "sg-075989c9284e07440"]
