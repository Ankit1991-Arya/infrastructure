...
module "msk" {
  ...
  vpc-id                                    = "vpc-0cda5cd4e766f5ce7"
  internet-gateway-id                       = "igw-0c27a8b5e19ad5b5a"
  subnet-cidrs                              = local.subnet-cidrs
  availability-zones                        = local.availability-zones
  allowed-cidrs                             = local.cidr_ranges.allowed_cidrs
  security_group_ids                        = ["sg-099f7686ab89f3309", "sg-0991ae856a11c2b2e", "sg-0b2e6cd4827b130a5", "sg-02277322bf6c68e28"]
