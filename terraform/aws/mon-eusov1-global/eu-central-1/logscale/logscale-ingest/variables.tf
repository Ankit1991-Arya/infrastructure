...
variable "ls_cloudtrail_name" {
  type    = string
  default = "mon-eusov1-global-cloudtrail-logs"
}

variable "ls_guardduty_name" {
  type    = string
  default = "mon-eusov1-global-guardduty-logs"
}

variable "sqs_subs_cloudtraillogs_name" {
  type    = string
  default = "mon-eusov1-global-cloudtraillogs"
}

variable "sqs_subs_guarddutylogs_name" {
  type    = string
  default = "mon-eusov1-global-guarddutylogs"
}
