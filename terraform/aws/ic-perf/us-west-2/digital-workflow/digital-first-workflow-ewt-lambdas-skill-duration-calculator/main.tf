...
module "digital-first-workflow-ewt-lambdas-skill-duration-calculator" {
  ...
  redis_url                           = "ewt-redis-cache-0001-001.ewt-redis-cache.acrb8y.usw2.cache.amazonaws.com:6379 ewt-redis-cache-0001-002.ewt-redis-cache.acrb8y.usw2.cache.amazonaws.com:6379"
  key_uri                             = "https://nicecxone-perf.com/auth/jwks"
}
