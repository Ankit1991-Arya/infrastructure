...
module "api-aurora-rds" {
  ...
  version = "0.4.9" // Version of the Terraform module to deploy

  environment     = "pfor"
  vpc_name_common = "CoreNetwork"
  eks_cidr        = "10.9.112.0/21"
  ...
  min_acu         = 1
  max_acu         = 10
  //instance_count  = 2 // Make sure to change the parameter num_rds_db_instance_ids in api-aurora-rds-alarms module
...
module "api-aurora-rds-alarms" {
  ...
  version = "0.0.11" // Version of the Terraform module to deploy
