...
module "msk" {
  ...
  vpc-id                                    = "vpc-01f56e698777057f9"
  internet-gateway-id                       = "igw-01fe8d680353b8809"
  subnet-cidrs                              = local.subnet-cidrs
  availability-zones                        = local.availability-zones
  allowed-cidrs                             = local.cidr_ranges.allowed_cidrs
  security_group_ids                        = ["sg-0775eaa8ec43fe1cd", "sg-0a5386bbc9b4ad122", "sg-07f27f57e4d039446", "sg-0aff9435db9989cdb"]
