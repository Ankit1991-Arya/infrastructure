...
resource "aws_ecr_pull_through_cache_rule" "docker_hub" {
  ...
  credential_arn        = "arn:aws:secretsmanager:us-west-2:545209810301:secret:ecr-pullthroughcache/dockerhub-8cDftB"
}

resource "aws_ecr_pull_through_cache_rule" "github" {
  ecr_repository_prefix = "ghcr.io"
  upstream_registry_url = "ghcr.io"
  credential_arn        = "arn:aws:secretsmanager:us-west-2:545209810301:secret:ecr-pullthroughcache/ghcr-TFFyQc"
}