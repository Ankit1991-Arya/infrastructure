...
# Uncomment below code if we want mrm elasticache to be created in ic-staging account
...
# No need to do anything in below code as it will create the alarms for mrm elasticache cluster when it is created in ic-staging account when mrm elasticache is created
