...
module "msk" {
  ...
  vpc-id                                    = "vpc-089697c23167c1fbd"
  internet-gateway-id                       = "igw-0ce6efa0d6c90dd3a"
  subnet-cidrs                              = local.subnet-cidrs
  availability-zones                        = local.availability-zones
  allowed-cidrs                             = local.cidr_ranges.allowed_cidrs
  security_group_ids                        = ["sg-059709f7b9548414c", "sg-0c827c5d0791b216e", "sg-0493c003181a66951", "sg-0ab119b52877e7520"]
