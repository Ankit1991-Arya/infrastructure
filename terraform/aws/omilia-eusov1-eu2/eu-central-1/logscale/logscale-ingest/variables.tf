...
variable "ls_cloudtrail_name" {
  type    = string
  default = "omilia-eusov1-eu2-cloudtrail-logs"
}

variable "ls_guardduty_name" {
  type    = string
  default = "omilia-eusov1-eu2-guardduty-logs"
}

variable "sqs_subs_cloudtraillogs_name" {
  type    = string
  default = "omilia-eusov1-eu2-cloudtraillogs"
}

variable "sqs_subs_guarddutylogs_name" {
  type    = string
  default = "omilia-eusov1-eu2-guarddutylogs"
}
