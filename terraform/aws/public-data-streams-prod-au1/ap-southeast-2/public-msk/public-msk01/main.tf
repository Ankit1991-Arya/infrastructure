...
module "msk" {
  ...
  vpc-id                                    = "vpc-08ba682cb83f8eee5"
  internet-gateway-id                       = "igw-0cbc58594f8218bd4"
  subnet-cidrs                              = local.subnet-cidrs
  availability-zones                        = local.availability-zones
  allowed-cidrs                             = local.cidr_ranges.allowed_cidrs
  security_group_ids                        = ["sg-02a9ece707e5365d8", "sg-070a766e699fc3318", "sg-08b680d5c3ed4d01f", "sg-0bff68f746531ae7a"]
