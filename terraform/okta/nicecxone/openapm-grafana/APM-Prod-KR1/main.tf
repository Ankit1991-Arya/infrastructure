...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-KR1"
  redirect_uris             = ["https://mon-kr1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-kr1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-kr1.nicecxone.com/logout"]
}