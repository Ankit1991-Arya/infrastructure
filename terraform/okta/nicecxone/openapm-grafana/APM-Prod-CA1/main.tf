...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-CA1"
  redirect_uris             = ["https://mon-ca1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-ca1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-ca1.nicecxone.com/logout"]
}