...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-EU1"
  redirect_uris             = ["https://mon-eu1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-eu1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-eu1.nicecxone.com/logout"]
}