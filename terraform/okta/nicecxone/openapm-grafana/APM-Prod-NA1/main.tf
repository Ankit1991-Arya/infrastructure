...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-NA1"
  redirect_uris             = ["https://mon-na1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-na1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-na1.nicecxone.com/logout"]
}