...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-UK1"
  redirect_uris             = ["https://mon-uk1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-uk1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-uk1.nicecxone.com/logout"]
}