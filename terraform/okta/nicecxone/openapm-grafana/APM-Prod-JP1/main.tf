...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-JP1"
  redirect_uris             = ["https://mon-jp1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-jp1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-jp1.nicecxone.com/logout"]
}