...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-AE1"
  redirect_uris             = ["https://mon-ae1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-ae1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-ae1.nicecxone.com/logout"]
}