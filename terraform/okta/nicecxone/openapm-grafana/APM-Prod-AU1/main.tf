...
module "okta_grafana" {
  ...
  label                     = "APM-Prod-AU1"
  redirect_uris             = ["https://mon-au1.nicecxone.com/login/okta"]
  login_uri                 = "https://mon-au1.nicecxone.com/login/okta"
  post_logout_redirect_uris = ["https://mon-au1.nicecxone.com/logout"]
}