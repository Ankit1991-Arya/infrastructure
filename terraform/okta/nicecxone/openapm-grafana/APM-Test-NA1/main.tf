...
module "okta_grafana" {
  ...
  label                     = "APM-Test-NA1"
  redirect_uris             = ["https://mon-na1.nicecxone-test.com/login/okta"]
  login_uri                 = "https://mon-na1.nicecxone-test.com/login/okta"
  post_logout_redirect_uris = ["https://mon-na1.nicecxone-test.com/logout"]
}
