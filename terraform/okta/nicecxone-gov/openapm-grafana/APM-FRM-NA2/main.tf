...
module "okta_grafana" {
  ...
  label                     = "APM-FRM-NA2"
  redirect_uris             = ["https://mon-na2.nicecxone-gov.com/login/okta"]
  login_uri                 = "https://mon-na2.nicecxone-gov.com/login/okta"
  post_logout_redirect_uris = ["https://mon-na2.nicecxone-gov.com/logout"]
}
